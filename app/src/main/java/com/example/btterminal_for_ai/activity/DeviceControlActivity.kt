...
import com.example.btterminal_for_ai.DeviceData
import com.example.btterminal_for_ai.R
import com.example.btterminal_for_ai.Utils
import com.example.btterminal_for_ai.bluetooth.DeviceConnector
import com.example.btterminal_for_ai.bluetooth.DeviceListActivity
...
class DeviceControlActivity : BaseActivity() {
    ...
    override fun onStart() {
        ...
        if (hexMode) {
            ...
            commandEditText!!.filters = arrayOf<InputFilter>(Utils.InputFilterHex())
        } else {
